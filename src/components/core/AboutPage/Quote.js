...
export const Quote = () => {
  return (<div className='text-4xl text-center relative'>
    <svg className='absolute left-5 -top-2' width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {" "}<span className='bg-gradient-to-br from-[#FF512F] to-[#F09819] bg-clip-text text-transparent'>expertise</span>, and community to create an 
    ...
    <svg className='absolute right-[296px] bottom-5' width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
